    ...
    userList.push(
      <div
        ...
        className={`
          ...
          cursor-pointer hover:bg-primary/25 items-center 
          ${bgColor}
      ...
      >
        ...
        */}
        ...
        <div className="hidden md:block text-base text-white w-4/12 h-full py-3 pr-6 whitespace-nowrap overflow-hidden text-ellipsis max-w-[100%]">
          {user.university}
        </div>
