  ...
  return (
    <>
      <header className="appHeader fixed top-0 justify-between flex w-full items-center h-16 z-50 py-4 lg:px-6 px-4">
        ...
        <a
          id="mlh-trust-badge"
          className="absolute right-2 md:right-4 lg:right-6 bottom-0 translate-y-full z-10 w-[5rem] h-[6rem] md:w-[6rem] md:h-[7rem] lg:w-[8rem] lg:h-[9rem] 2xl:w-[10rem] 2xl:h-[11rem]"
