...
export default function HomeHero() {
  ...
  return (
    <section className="min-h-screen p-4 bg-contain bg-[url('/assets/hero-bg.png')]  md:mt-[-8rem] mt-[-5rem] md:pt-[7rem] pt-[10rem] flex flex-col justify-center">
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="mx-auto 2xl:w-[75rem] 2xl:h-[33rem] lg:w-[48rem] lg:h-[19rem] md:w-[40rem] md:h-[15rem] sm:w-[35rem] sm:h-[12rem] w-[22rem] h-[9rem] relative md:mt-0 mt-20 pointer-events-none">
        ...
        <div className=" flex flex-col items-center justify-center w-full mt-10 xl:mt-20">
