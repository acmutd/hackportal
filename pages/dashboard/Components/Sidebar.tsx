...
function Sidebar() {
  ...
  return (
    <>
      ...
      <section
        id="Sidebar"
        className="text-black hidden md:flex flex-col content-center justify-center items-center h-screen fixed top-16 lg:w-1/8 md:w-1/7 w-1/6 border-r-2 border-gray-600 text-xs lg:text-sm text-center bg-white"
      >
        <div>
          Welcome,{' '}
